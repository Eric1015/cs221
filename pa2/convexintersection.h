...
// determines whether p1 has coordinates that are within the range defined by sp1 and sp2
// helper function for computeIntersection and also getConvexIntersection
bool pointInRange(Point p1, Point sp1, Point sp2);

// add points of poly1 that are inside poly2 into intersection
// helper function for getConvexIntersection
void addPointsInside(vector<Point>& intersection, const vector<Point> poly1, const vector<Point> poly2); 

// compute the intersection made by a vertical line and a non-vertical line
// helper function for computeIntersection
